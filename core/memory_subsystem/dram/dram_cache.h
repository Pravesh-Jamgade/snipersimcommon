...
class DramCache : public DramCntlrInterface
{
   ...
   private:
      ...
      std::pair<bool, SubsecondTime> doAccess(Cache::access_t access, IntPtr address, core_id_t requester, Byte* data_buf, SubsecondTime now, ShmemPerf *perf, IntPtr eip);
